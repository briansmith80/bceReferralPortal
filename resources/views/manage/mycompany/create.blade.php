...
<div id="app">
  ...
  <!-- general form elements -->
          <div class="box box-primary">
            ...
            <form action="{{ route('mycompany.store') }}" role="form" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <span class="input-group-addon">http://</span>
                      <input type="text" class="form-control" id="website_url" name="website_url" value="{{ old('website_url') }}" placeholder="www.">
                  </div>
