...
<div id="app">
  ...
  <!-- general form elements -->
          <div class="box box-primary">
            ...
            <form action="{{route('mycompany.update', $companies->id) }}" role="form" method="POST" enctype="multipart/form-data">
            {{method_field('PUT')}}
            {{ csrf_field() }}
              ...
              <div class="col-md-6">
               ...
               <!--  <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="website_url" name="website_url" value="{{ $companies->website_url }}" placeholder="http://www.">
                </div>
