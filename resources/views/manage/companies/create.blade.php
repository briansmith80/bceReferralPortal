              ...
              <input type="hidden" id="user_id" name="user_id"  value="{{ Auth::user()->id }}">
               ...
               <!--  <div class="form-group">
                ...
                <div class="form-group @if ($errors->has('company_name')) has-error @endif">
                  ...
                  <input type="text" class="form-control" id="company_name" name="company_name" value="{{ old('company_name') }}" placeholder="Enter Business Name" required>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="website_url" name="website_url" value="{{ old('website_url') }}" placeholder="Enter website http://www....">
                </div>
                ...
                <div class="form-group">
                  ...
                  <!-- <input type="text" class="form-control" id="product_services" name="product_services" value="{{ old('product_services') }}" placeholder="Enter ID number"> -->
                ...
                <div class="form-group">
                 ...
                 <select class="form-control select2" style="width: 100%;" id="company_type" name="company_type" value="{{ old('company_type') }}" placeholder="Enter Type">
                ...
                <div class="form-group">
                  <label for="discription">Years Operated</label>
                  <input type="text" class="form-control" id="years_operated" name="years_operated" value="{{ old('years_operated') }}" placeholder="Enter Description">
                </div>

                 <div class="form-group">
                  <label for="discription">Address</label>
                  <input type="text" class="form-control" id="physical_address" name="physical_address" value="{{ old('physical_address') }}" placeholder="Enter Description">
                </div>
